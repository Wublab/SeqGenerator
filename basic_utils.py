...
from diffuseq.esm2.model.esm2 import ESM2
...
def create_model_and_diffusion(
    ...
    **kwargs,
    ...
    if model_regression_path != '':
        regression_data = torch.load(model_regression_path)
    ...
    return model, diffusion, alphabet, state_dict
